...
import src.models.preprocess as preprocess, src.models.utils as utils
...
def naive_bayes(sampling = False, isNotebook = False):
    ...
    DATA_FILE = Path(r'C:\Users\John Locke\PycharmProjects\DiplomaProjectCovid\src\data\covid-dataset.csv')
    #DATA_FILE = "/src/data/covid-dataset.csv"
