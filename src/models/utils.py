...
def _save_plt_bar_chart(features, weight, classifier, feat_type, yes, no):
    '''
    Saves plt bar chart picture.
    '''
    plt.clf()
    ...
    plt.savefig(f"static/results/{classifier}/plt_bar_char", bbox_inches='tight')
